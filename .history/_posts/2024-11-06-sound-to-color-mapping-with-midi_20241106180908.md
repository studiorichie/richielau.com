...
[Check out the interactive sound-to-color mapping here!](assets/sound-to-color.html)


```html
<iframe src="/assets/sound-to-color.html" width="800" height="600" frameborder="0"></iframe>
```